package com.nogemasa.signature.util;
...
public final class RsaSigner {
     ...
     * @throws java.security.NoSuchAlgorithmException 如果当前运行环境中不支持 SHA256withRSA 算法
     * @throws java.security.InvalidKeyException      私钥不合法
     * @throws java.security.SignatureException       签名对象没有正确初始化
     */
     ...
     * @return Base64编码的签名字符串
     * @throws java.security.spec.InvalidKeySpecException  如果私钥字符串不合法。
     * @throws java.security.NoSuchAlgorithmException 如果当前运行环境中不支持RSA算法
     * @throws java.security.SignatureException       签名对象没有正确初始化
     * @throws java.security.InvalidKeyException      私钥不合法
