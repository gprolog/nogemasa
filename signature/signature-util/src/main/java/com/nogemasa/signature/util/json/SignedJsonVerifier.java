package com.nogemasa.signature.util.json;

import com.nogemasa.signature.util.RsaSignatureVerifier;
...
public final class SignedJsonVerifier {
     ...
     * @throws com.nogemasa.signature.util.json.SignedJsonVerifyException
     */
    public static String verify(String jsonString, PublicKey publicKey)
    ...
    public static String verify(String jsonString, PublicKeyProvider publicKeyProvider)
        ...
        return verify(jsonString, publicKey);
    }
